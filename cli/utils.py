...
TICKER_INPUT_EXAMPLES = "SPY, CNC.TO, 7203.T, 0700.HK, 600519, 000001, BTC-USD"
...
def normalize_ticker_symbol(ticker: str) -> str:
    ...
    try:
        ...
        if getattr(market, "value", None) != "us":
            return normalized
    except Exception:
        pass
...
def _llm_provider_table() -> list[tuple[str, str, str | None]]:
    ...
    return [
        ...
        ("Xiaomi MiMo", "xiaomi", os.environ.get("XIAOMI_BASE_URL") or "https://api.xiaomimimo.com/v1"),
